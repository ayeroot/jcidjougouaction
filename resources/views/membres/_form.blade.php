...
<div class="grid sm:grid-cols-2 gap-5">
    ...
    <div class="sm:col-span-2">
        ...
        <img src="{{ $membre->photo_url }}" alt="" class="w-20 h-20 rounded-full object-cover mb-2 border">
        ...
        <p class="text-xs text-slate-400 mt-1">JPG/PNG, 2 Mo max. Facultative : sans photo, un avatar homme ou femme s'affiche selon le sexe.</p>
    </div>
    <div>
